...
export const SERVICE_SEARCH_TERMS: Record<string, string[]> = {
  ...
  "oto-tamir": ["oto tamir", "araba tamiri", "oto servis", "araç servisi", "motor tamiri", "periyodik bakım"],
  "tekne-tamiri": ["tekne tamiri", "bot tamiri", "marin servis", "tekne bakımı", "tekne motoru tamiri"],
...
export const CATEGORY_SEARCH_TERMS: Record<string, string[]> = {
  ...
  tamirat: ["tamirci", "servis", "beyaz eşya servisi", "onarım", "oto tamir", "tekne tamiri"],
...
export const SERVICE_SLUG_ALIASES: Record<string, string> = {
  ...
  "oto-servis": "oto-tamir",
  "oto-tamir": "oto-tamir",
  "araba-tamiri": "oto-tamir",
  "arac-tamiri": "oto-tamir",
  "otomobil-tamiri": "oto-tamir",
  "tekne-tamiri": "tekne-tamiri",
  "bot-tamiri": "tekne-tamiri",
  "marin-servis": "tekne-tamiri",
  "tekne-servis": "tekne-tamiri",
