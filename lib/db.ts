...
export const countCustomerQuotesByPhone = delegate("countCustomerQuotesByPhone");
export const getCustomerQuoteTabCounts = delegate("getCustomerQuoteTabCounts");
...
export const getPublishedProviderOfTheMonth = delegate("getPublishedProviderOfTheMonth");
export const getProviderOfTheMonthByPeriod = delegate("getProviderOfTheMonthByPeriod");
export const publishProviderOfTheMonth = delegate("publishProviderOfTheMonth");
export const unpublishProviderOfTheMonth = delegate("unpublishProviderOfTheMonth");
export const getAcceptedContactDetails = delegate("getAcceptedContactDetails");
export const recordCustomerInitiatedContact = delegate("recordCustomerInitiatedContact");
export const getOpenQuotesForProvider = delegate("getOpenQuotesForProvider");
export const activateProviderBorcKredisi = delegate("activateProviderBorcKredisi");
...
export const getProviderOffersByProviderId = delegate("getProviderOffersByProviderId");
export const getCustomerProfile = delegate("getCustomerProfile");
export const updateCustomerProfile = delegate("updateCustomerProfile");
export const updateQuoteRequestLocation = delegate("updateQuoteRequestLocation");
export const acceptProviderOffer = delegate("acceptProviderOffer");
export const counterOffer = delegate("counterOffer");
...
export const submitProviderOfferReview = delegate("submitProviderOfferReview");
export const getPublicProviderReviews = delegate("getPublicProviderReviews");
export const getProviderReviewStats = delegate("getProviderReviewStats");
